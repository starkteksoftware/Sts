...
public class LogIn implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        doBeforeProcessing(wrappedRequest, wrappedResponse);
           String param = wrappedRequest.getRequest().getParameter("username");
            String param2 = wrappedRequest.getRequest().getParameter("password");
            System.err.println(param);
            
            if(param == null || param2 == null){
                 String host =  wrappedRequest.getHeader("host");
                System.err.println("proccessing in filter");
        System.err.println("in filter "+wrappedRequest.getSession().getId());
          System.err.println("in filter "+wrappedRequest.getRequestedSessionId());
          System.err.println("in filter "+wrappedRequest.getSession().getCreationTime());
          boolean f = false;
          if(!f)
               try{
              wrappedResponse.sendRedirect("http://"+host+"/AAAASTUDENT/LogIn.html");
               }
          catch(IllegalStateException e){
             //  wrappedResponse.sendRedirect("http://"+host+"/AAAASTUDENT/LogIn.html");
              
          }
              //sendProcessingError(Throwable t, response);
              }
            else{
                System.err.println("contains log in");
            }
     ...
     /*     if( com.rest.service.LogIn.value != true) {
                ...
                wrappedResponse.sendRedirect("http://"+host+"/AAAASTUDENT/OngoingExams.html");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("LogIn::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("LogIn::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("LogIn::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("LogIn::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("LogIn::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
