...
/* the main function */
 ...
 function guessit()
 {
   ...
   window.status = "Tries : " + tries + "              (C) Starktek";
  ...
  function catchKeyCode(e) //calls when the user press the RETURN key
 {
 ...
 document.getElementById("keypress",catchKeyCode,false);
