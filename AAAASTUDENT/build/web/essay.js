  ...
  pageC.innerHTML = page;
    ...
    for(var c = 0; c < array.length; c++){
     ...
     for(var i = 0; i < split.length; i++){
         ...
         b +="<p>"+split[i]+"</p>";
                 ff += "  <p style='margin-left:25%'><textarea rows='11' cols='56' id='"+page+"' value='"+totalQuestions[page]+"' class='margin5'>"+totalQuestions[page]+"</textarea>"+"</p> ";                         
       ...
       ff+="  <p style='margin-left:40%'><input type='textarea' rols='6' cols='24' id='"+i+"' value='' class='margin5'/>"+"</p> ";       
  ...
  // ele.innerHTML = minutes+'m'+seconds+'s'+milliseconds+'ms';
   ...
   if( mm % 2 == 0){
     ...
     maintainvalue = mm;
       ...
       totalQuestions[page] = document.getElementById(page).value;
...
function sendMessage(){
   questionSender = [];
  for(var c = 0; c < totalQuestions.length; c++){
     questionSender[c] = totalQuestions[c]+"eNdanswEr"; 
     
  }
  
    wsocket.send("matric="+matricNumber+"&time="+mm+"&answers="+questionSender+"&subject="+topic);
...
function submitted(){
  ...
  for(var c = 0; c < totalQuestions.length; c++){
    ...
    wsocket.send("matric="+matricNumber+"&time=0&answers="+questionSender+"&subject="+topic);
