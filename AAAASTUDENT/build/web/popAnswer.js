...
function pages(e){
  ...
  pageC.innerHTML = page;
    ...
    for(var c = 0; c < array.length; c++){
      ...
      var spp = array[c].toString() +"#time:10";
       
     var splitt = spp.split("#time:");
       
     var secondings =  splitt[1].split(",");
      
    
      //  seconding = secondings[0];
            var split = splitt[0].split("#");
     ...
     for(var i = 0; i < split.length; i++){
       ...
       ff+="  <p style='margin-left:40%; background-color:red;'><input type='radio' checked name='jol' id='"+i+"' class='margin5'/>"+split[i].substring(6,split[i].length)+"</p> ";       
         //   b +="<tr><td><input type='radio' checked name='jol' id='"+i+"' /></td><td>"+split[i]+" </td> </tr>";      
                            }
                            else{
                           ff+="  <p style='margin-left:40%; background-color:green;'><input type='radio' checked name='jol' id='"+i+"' class='margin5'/>"+split[i].substring(6,split[i].length)+"</p> ";       
                   ...
                   if(split[i].indexOf("option") != -1){
                    ff+= "  <p style='margin-left:40%'><input type='radio' name='jol' id='"+i+"' class='margin5'/>"+split[i].substring(6,split[i].length)+"</p> ";       
                           ...
                           ff+= "  <p style='margin-left:40%; background-color:green;'><input type='radio' name='jol' id='"+i+"' class='margin5'/>"+split[i].substring(6,split[i].length)+"</p> ";       
...
function submitted(){
 ...
 function showAnswer(){
   ...
   var string = "";   
    ...
    //
    //   var splitt = array[c].toString().split("#time:");
