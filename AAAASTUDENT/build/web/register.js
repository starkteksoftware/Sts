...
localStorage.setItem("firstName",firstName);
   ...
   var requestUrl = sessionStorage.getItem("URL")+"/AAAACLIENT/webresources/student/register?"+buildUrl;
    ...
    document.getElementById("form").setAttribute("style","opacity:0.2");
...
function parseData(asyncRequest){
 ...
 if (data.toString().indexOf(":") !== -1){
     ...
     localStorage.setItem("matric",split[1]);
     
     
         window.location.assign(sessionStorage.getItem("URL")+"/AAAASTUDENT/registerSubject.html");
