     ...
     for(var i = 0; i < split.length; i++){
         ...
         b +="<p>"+split[i]+"</p>";
             ...
             if(answer){
                        ...
                        if(i  == questionv){
       ff+="  <p style='margin-left:40%'><input type='radio' checked name='jol' id='"+i+"' class='margin5'/>"+split[i]+"</p> ";       
         //   b +="<tr><td><input type='radio' checked name='jol' id='"+i+"' /></td><td>"+split[i]+" </td> </tr>";      
              }
              else{
                    ff+= "  <p style='margin-left:40%'><input type='radio' name='jol' id='"+i+"' class='margin5'/>"+split[i]+"</p> ";       
