  ...
  div.setAttribute('id',(c+1)+'.'); */
    ...
    //  parentNode.insertBefore(div,paginateDiv);
        ...
        for(var ii = 0; ii < arr.length; ii++){
          var sepe = arr[ii].split("sNdsnswEr"); 
          for(var e = 0; e < sepe.length; e++){ 
            if(e % 2 == 0){
                totalQuestions.push(sepe[e]);
            }
            else{
                var splitter = sepe[e].split("eNdanswEr");
               totalAnswer.push(splitter[0]); 
  ...
  pageC.innerHTML = page;
   ...
   break;
      ...
      tab.innerHTML = b;
         ...
         ff += "  <p style='margin-left:25%'><textarea rows='11' cols='56' id='hey' value='"+totalAnswer[page]+"' class='margin5'>"+totalAnswer[page]+"</textarea>"+"</p> ";                         
...
function sendMessage(){
  ...
  for(var c = 0; c < totalQuestions.length; c++){
     questionSender[c] = totalQuestions[c]+"sNdsnswEr"+totalAnswer[c]+"eNdanswEr"; 
...
function press(e){
   ...
   totalAnswer[page] = document.getElementById("hey").value;
