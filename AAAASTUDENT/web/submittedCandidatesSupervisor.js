...
var submittedCandidatesSupervisor =[];
function start(){
    arrange();
}
...
function arrange(){
  ...
  document.getElementById("filterFindsss").addEventListener("keydown",keydownMethodIngss,false);
   var submit = document.getElementById("clickedFindsss");
    submit.addEventListener("click",searchMethodIngss,false);
    
    
    
  submittedCandidatesSupervisor = [];
    
    
    
    
      var table = document.getElementById("tableFindsss");
     
   
   
 
      
      var sec =  localStorage.getItem("submitActive").split("#");
  ...
  ids= splitted[0]+","+splitted[1]+","+split[2]+","+split[3]+","+split[1];
    ...
    submittedCandidatesSupervisor.push(addition);
...
function searchMethodIngss(){
    
     
     
     var filt = document.getElementById("filterFindsss");
     ...
     if(filt.length > 0){
         ...
         var sep = submittedCandidatesSupervisor.toString();
   ...
   for(var ii =0; ii < addSplit.length; ii++){
     ...
     var splitAgain = copy.split("undefined");
           ...
           document.getElementById("tableFindsss").innerHTML = splitAgain[1];   
