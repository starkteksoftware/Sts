...
//localStorage.setItem("student",str);
 ...
 for(var c=0; c<splitter.length; c++){
     ...
     var table = document.getElementById("tableBodyUnreg");
     var sec = str.split("#");
     ...
     for(var ii = 0; ii <= remainder; ii++){
          stri+='<button class="btn ades btn-info" id="pg'+ii+'" type="button">'+(ii + 1)+'</button>';
      }
      
      $("#unregPg").html(stri);
       $(".ades").click(function (e){
           $(".ades").removeClass("active");
